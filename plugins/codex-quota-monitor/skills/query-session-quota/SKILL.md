...
- Task totals, execution durations, and attribution use the configured sliding statistics window (24 hours by default, adjustable from 1 to 168 hours). Include unattributed usage when known and nonzero; preserve partial/lower-bound coverage labels for old records. Increasing the window cannot recover observations already removed.
